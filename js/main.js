...
/*************************************************************************************
------------ ANSWER -------------------
Both x and y are local variables because they are defined inside of the function.  console.log(x)  will print "I'm a local variable"  console.log(y) will print undefined.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will print undefined because it is not defined until after the console.log().  Console.log(foo()) will print "function hoisting" because the function is hoisted to the top.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
Inside the function it will print 4 but outside the function it will print undefined because the variable was defined inside the function.
**************************************************************************************/
